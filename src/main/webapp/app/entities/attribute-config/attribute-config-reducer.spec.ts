...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ATTRIBUTECONFIG_LIST actions', async () => {
    ...
    it('dispatches FETCH_ATTRIBUTECONFIG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ATTRIBUTECONFIG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ATTRIBUTECONFIG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ATTRIBUTECONFIG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ATTRIBUTECONFIG actions', async () => {
      const expectedActions = [
        {
