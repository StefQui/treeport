...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './attribute.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ATTRIBUTE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ATTRIBUTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ATTRIBUTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ATTRIBUTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ATTRIBUTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ATTRIBUTE actions', async () => {
      const expectedActions = [
        {
