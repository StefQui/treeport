...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './campaign.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CAMPAIGN_LIST actions', async () => {
    ...
    it('dispatches FETCH_CAMPAIGN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CAMPAIGN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CAMPAIGN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CAMPAIGN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CAMPAIGN actions', async () => {
      const expectedActions = [
        {
