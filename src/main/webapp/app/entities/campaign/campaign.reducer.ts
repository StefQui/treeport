...
export const createEntity = createAsyncThunk(
  ...
  async (entity: ICampaign, thunkAPI) => {
    const result = await axios.post<ICampaign>(apiUrl, cleanEntity(entity));
...
export const updateEntity = createAsyncThunk(
  ...
  async (entity: ICampaign, thunkAPI) => {
    const result = await axios.put<ICampaign>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError },
...
export const partialUpdateEntity = createAsyncThunk(
  ...
  async (entity: ICampaign, thunkAPI) => {
    const result = await axios.patch<ICampaign>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError },
...
export const deleteEntity = createAsyncThunk(
  ...
  async (id: string | number, thunkAPI) => {
    const requestUrl = `${apiUrl}/${id}`;
    const result = await axios.delete<ICampaign>(requestUrl);
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError },
