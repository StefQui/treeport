...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORGANISATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_ORGANISATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ORGANISATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ORGANISATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ORGANISATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ORGANISATION actions', async () => {
      const expectedActions = [
        {
